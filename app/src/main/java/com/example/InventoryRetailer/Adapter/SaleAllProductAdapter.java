...
public class SaleAllProductAdapter extends RecyclerView.Adapter<SaleAllProductAdapter.MyViewHolder> {

    ArrayList<Sale_All_Product_Model> orderCartModels;
    Context context;

    public SaleAllProductAdapter(Context context, ArrayList<Sale_All_Product_Model> orderCartModels) {
